...
const SHELL_COMMAND_ALIASES = {
  ...
  journal: ['journal', 'log', '日志', '玩家日志', '个人史'],
  explore: ['explore', '探索', '探查', '搜索'],
  board: ['board', 'commission', '委托', '任务板', '悬赏'],
  accept: ['accept', '接取', '接受', '接任务'],
  inventory: ['inventory', 'inv', 'bag', '背包', '物品', '行囊'],
  equip: ['equip', '装备', '穿戴'],
  unequip: ['unequip', '卸下', '脱下'],
  use: ['use', '使用', '服用'],
  shop: ['shop', 'store', '商店', '市场'],
  buy: ['buy', '购买', '买'],
  sell: ['sell', '出售', '卖'],
