...
| 数据库配置与持久化 | 93% -> 96% | 已新增 listDatabaseEvents 和 GET /admin/database/events，可按 worldId、type、limit、order 查询事件。 |
...
DATABASE_EVENT_ADMIN.md
database-event-admin-test.js
api-server.js endpoint list 更新
package.json 追加 database-event-admin 回归测试
```
