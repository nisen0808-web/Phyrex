...
| 治理、过程、冲突 | 45% -> 56% | 治理系统已读取城市、经济、人口、自然灾害和产业停摆压力，并能触发集体响应。 |
| 治理环境响应层 | 0% -> 100% | 已完成救灾、公共工程、配给、治安维护、税率调整和组织动员。 |
...
GOVERNANCE_ENVIRONMENT_RESPONSE.md
world.governance.environment 治理环境摘要
government.environment 单个政府环境信号
disaster_relief / public_works / rationing / security_crackdown / tax_adjustment / mobilization
治理响应世界级确定性 ID
civilization.governance Contract 扩展 environment 和 responses
```

## 下一批建议

```text
1. 让 process-engine 读取治理响应，把救灾、公共工程、动员扩展为多 tick 过程。
2. 让 conflict-engine 读取 security_crackdown 和 mobilization，影响骚乱、镇压和组织冲突。
3. 让 opportunity-engine 读取治理环境摘要，生成公共救灾、工程、贸易和迁徙机会。
4. 增加贸易流系统，根据城市风险和价格差自动移动资源。
