...
| 世界级确定性 ID | 91% | 城市、市场、产业、交易、目标和目标记忆 ID 已迁移到世界级确定性 ID。 |
...
| 智能体目标规划 | 45% -> 72% | AI 目标层开始读取城市、经济、自然、生态、人口和资源压力。 |
| AI 环境目标层 | 0% -> 100% | 已完成环境信号、避灾、迁徙、囤积、采集、找工作、支援城市目标和行动映射。 |
| 信息、记忆、文化、宗教 | 55% | 已接入管线；仍需传播网络和文化变迁细化。 |
| 文明、科技、基础设施 | 50% | 已接入管线；仍需时代、扩散和依赖网络。 |
| 治理、过程、冲突 | 45% | 已接入管线；仍需外交、战争、法律系统。 |
| 自然、气候、生态 | 55% | 自然世界和生态主模块已完成基础版，并能向人口、城市、经济和 AI 目标系统提供压力数据。 |
...
AI_ENVIRONMENT_GOALS.md
profile.environment 环境信号
seek_shelter / migrate / stockpile_resource / gather_resources / find_work / support_city
目标和目标记忆确定性 ID
```
